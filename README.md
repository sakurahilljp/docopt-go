...
[![GoDoc](https://godoc.org/github.com/sakurahilljp/docopt.go?status.svg)](https://godoc.org/github.com/sakurahilljp/docopt.go)
...
```go
import "github.com/sakurahilljp/docopt-go"
```

To install docopt in your `$GOPATH`:

```console
$ go get github.com/sakurahilljp/docopt-go
```

## API

Given a conventional command-line help message, docopt processes the arguments. See https://github.com/sakurahilljp/docopt#help-message-format for a description of the help message format.
...
More documentation is available at [godoc.org](https://godoc.org/github.com/sakurahilljp/docopt-go).
